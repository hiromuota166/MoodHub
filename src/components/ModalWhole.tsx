...
const ModalWhole = (props: Props) => {
	...
	const { updateCategoriesState, handleUpdateCategories } = useMusicRecommendPageData(userId, roomId);
	...
	return (
		<div className='relative'>
			<button title='isBtn' onClick={() => setIsOpen(true)}>
				<Image src='/filter.svg' width={500} height={500} alt='Description' className='ml-80 w-10 mt-5' />
			</button>
